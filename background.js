    ...
    if (info.menuItemId === "Kryptos") {
        ...
        const colors = (ar) => {
            for (let i = 0; i <= ar.length; i++) {
                ...
                data += ` var square = document.createElement("div"); square.style.width = "1px"; square.style.float="left"; square.style.height = "1px"; square.style.backgroundColor = ${color}; document.body.appendChild(square);`;  
                if ((i%9) ^ ar === 0) {
                    color = `"rgp(66, 66, 66)"`;
                    data += ` var square = document.createElement("div"); square.style.width = "1px"; square.style.float="left"; square.style.height = "1px"; square.style.backgroundColor = ${color}; document.body.appendChild(square);`;  
                }
